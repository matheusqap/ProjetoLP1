/**
@file main.cpp
@brief Arquivo que contém a implementação das funções da classe abstrata 'Coluna', da classe herdeira 'AFazer',
da classe herdeira 'EmAndamento', da classe herdeira 'Aprovacao' e da classe herdeira 'Feito'.
