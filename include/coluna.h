/**
@file main.cpp
@brief Arquivo que contém a implementação da classe abstrata 'tarefa' e das suas classes herdeiras,
da classe herdeira 'AFazer', da classe herdeira 'EmAndamento', da classe herdeira 'Aprovacao'
 e da classe herdeira 'Feito'. Neste arquivo estão apenas as assinaturas dos métodos dessas classes.
